...
- **07-23:** **Sewer bill calibrated + water cost validated.** City of WH sewer bill (3/8-4/7/26) → sewer base $22.74 + $0.00982/gal added to utility cost estimate. WHUD water bill (05/28/26) confirmed rates ($10.32 + $0.00908/gal printed on bill, math validated: $39.90 for 3,258 gal). Old meter 17272512 swapped for 25394131 ~4/29/26 (one active meter, RTL-SDR captures all). Irrigation sewer rate corrected from old estimate ($0.01136) to bill-validated ($0.00982). Label now "Est. Water+Sewer." CAR `carCmdFail()` added with pull-mode/404/401/502 diagnostics + `carScanEntities()` rewritten with CONNECTION HEALTH + COMMAND CHECKLIST. `temperature_configure` fixed to send strings not numbers.
